...
> 1. Values of Variable Activity consist of data from “Y_train.txt” and
    “Y_test.txt” 
...
In the former part, variables activity and subject and names of the activities have been labelled using descriptive names.In this part, Names of Features will labelled using descriptive variable names.
